...
public class AttendanceManagementSystem extends JFrame implements ItemListener, ActionListener
{
	...
	public AttendanceManagementSystem(String tit, String dbnm, String qry){
		this.con  = null;
		this.stmt = null;
		this.rs = null;
		this.rsMeta=null;	
...
public static void main(String args[])
	{
	 new AttendanceManagementSystem("..:: Attendance Form ::.. ", "mydb.mdb", "SELECT *  FROM students order by Rollno");
	}
